...
typedef UINT8 BYTE;
//CHAR	字符类型，无符号8位整数
typedef char	CHAR;//typedef UINT8 CHAR;		
...
//LONG 	长整数，有符号32位整数	
typedef long		LONG;//typedef INT32 LONG;
//ULONG	长整数，无符号32位整数
typedef unsigned long	ULONG;    //typedef UINT32 ULONG;
//UINT	无符号32位整数	
typedef UINT32 UINT;
//WORD	字类型，无符号16位整数	
typedef UINT16 WORD;
//DWORD	双字类型，无符号32位整数
typedef unsigned long	DWORD;//typedef UINT32 DWORD;
//FLAGS	标志类型，无符号32位整数	
